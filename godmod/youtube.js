...
_*GODMOD-MD IS DOWNLOADING YOUR FILE📂*_\n\n`
       }
...
zokou({
  ...
  try {
    ...
    if (videos && videos.length > 0 && videos[0]) {
      ...
      let InfoMess = {
        image: { url: videos[0].thumbnail },
        caption: `*⏣GODMOD-MD VIDEO DOWNLOADER⏣*\n\n*Video name :* _${Element.title}_
*Time :* _${Element.timestamp}_
*Url :* _${Element.url}_
_*\n GODMOD MD IS DOWNLOADING YOUR FILE📂*_\n\n`
      };
      ...
      fileStream.on('finish', () => {
        ...
        zk.sendMessage(origineMessage, { video: { url :"./video.mp4"} , caption: "*⏣GENERATED BY GODMOD MD⏣*", gifPlayback: false }, { quoted: ms });
      });
